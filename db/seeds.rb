...
propertyB=Property.create!(
    area_id: area_toshima.id,area_group_id: area_ikebukuro.id,property_name:'物件B', address:'東京都', access:'池袋駅 徒歩7分', rent:50000, condition:'男女どちらともOK', vacancy:'個室4', introduction:'主要駅までのアクセス良好です', common_service_fee:18000,
