...
propertyA=Property.create!(
    area_id: area_nerima.id,area_group_id: area_group_ikebukuro.id, property_name:'ファースト南大泉', address:'東京都練馬区南大泉', access:'保谷駅 徒歩3分', rent:40000, condition:'女性', vacancy:6, common_service_fee:15000,
...
propertyE=Property.create!(
    area_id: area_shinagawa.id,area_group_id: area_group_kamata.id,property_name:'スカイ大崎', address:'東京都品川区大崎', access:'大崎駅 徒歩4分', rent: 30000, condition:'男女どちらともOK', vacancy:2, common_service_fee:15000,
...
propertyF=Property.create!(
    area_id: area_katushika.id,area_group_id: area_group_kitasenju.id,property_name:'ハイツ亀有', address:'東京都葛飾区亀有', access:'亀有駅 徒歩4分', rent: 30000, condition:'男女どちらともOK', vacancy:8, common_service_fee:15000,
...
propertyG=Property.create!(
    area_id: area_oota.id,area_group_id: area_group_kamata.id,property_name:'ステージ蒲田', address:'東京都太田区蒲田', access:'蒲田駅 徒歩8分', rent: 30000, condition:'男女どちらともOK', vacancy:6,common_service_fee:15000,
...
propertyH=Property.create!(
    area_id: area_edogawa.id,area_group_id: area_group_kitasenju.id,property_name:'スター江戸川', address:'東京都江戸川区西葛西', access:'西葛西駅 徒歩8分', rent: 30000, condition:'男女どちらともOK', vacancy:6,  common_service_fee:15000,
...
propertyI=Property.create!(
    area_id: area_nakano.id,area_group_id: area_group_nakano.id,property_name:'スターハイツ東中野', address:'東京都中野区東中野', access:'東中野駅 徒歩1分', rent: 50000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyJ=Property.create!(
    area_id: area_bunkyo.id,area_group_id: area_group_ikebukuro.id,property_name:'千駄木Fairy', address:'東京都文京区千駄木', access:'千駄木駅 徒歩3分', rent: 60000, condition:'男女どちらともOK', vacancy:6, 'common_service_fee':15000,
...
propertyK=Property.create!(
    area_id: area_kita.id,area_group_id: area_group_ikebukuro.id,property_name:'コモン上十条', address:'東京都北区上十条', access:'上十条駅 徒歩4分', rent: 30000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyL=Property.create!(
    area_id: area_daito.id,area_group_id: area_group_ueno.id,property_name:'SPICA上野', address:'東京都台東区上野', access:'上野駅 徒歩4分', rent: 50000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyM=Property.create!(
    area_id: area_arakawa.id,area_group_id: area_group_kitasenju.id,property_name:'町屋ハウス', address:'東京都荒川区町屋', access:'町屋駅 徒歩3分', rent: 40000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyN=Property.create!(
    area_id: area_adachi.id,area_group_id: area_group_kitasenju.id,property_name:'share綾瀬', address:'東京都足立区綾瀬', access:'綾瀬駅 徒歩5分', rent: 30000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyO=Property.create!(
    area_id: area_sumida.id,area_group_id: area_group_ueno.id,property_name:'フィネッツァ両国', address:'東京都墨田区両国', access:'両国駅 徒歩10分', rent: 50000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyP=Property.create!(
    area_id: area_kouto.id,area_group_id: area_group_ueno.id,property_name:'MONZENNAKAMACHI', address:'東京都江東区門前仲町', access:'門前仲町駅 徒歩10分', rent: 50000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyQ=Property.create!(
    area_id: area_itabashi.id,area_group_id: area_group_ikebukuro.id,property_name:'サザン板橋', address:'東京都板橋区板橋', access:'板橋駅 徒歩2分', rent: 30000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyR=Property.create!(
    area_id: area_suginami.id,area_group_id: area_group_nakano.id,property_name:'杉並の家', address:'東京都杉並区荻窪', access:'荻窪駅 徒歩10分', rent: 50000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyS=Property.create!(
    area_id: area_shibuya.id,area_group_id: area_group_ebisu.id,property_name:'BeGood_Daikanyama', address:'東京都渋谷区代官山', access:'代官山駅 徒歩2分', rent: 80000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyT=Property.create!(
    area_id: area_meguro.id,area_group_id: area_group_ebisu.id,property_name:'フィーユ中目黒', address:'東京都目黒区中目黒', access:'中目黒駅 徒歩5分', rent: 70000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyU=Property.create!(
    area_id: area_shinjuku.id,area_group_id: area_group_nakano.id,property_name:'テラス西新宿', address:'東京都新宿区西新宿', access:'西新宿駅 徒歩2分', rent: 60000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyV=Property.create!(
    area_id: area_minato.id,area_group_id: area_group_roppongi.id,property_name:'麻布Breeze', address:'東京都港区麻布十番', access:'麻布十番駅 徒歩5分', rent: 80000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyW=Property.create!(
    area_id: area_chiyoda.id,area_group_id: area_group_roppongi.id,property_name:'kiki大手町', address:'東京都千代田区大手町', access:'大手町駅 徒歩12分', rent: 70000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyX=Property.create!(
    area_id: area_chuo.id,area_group_id: area_group_roppongi.id,property_name:'ARDEN築地', address:'東京都中央区築地', access:'築地駅 徒歩10分', rent: 60000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyY=Property.create!(
    area_id: area_other.id,area_group_id: area_group_other.id,property_name:'ソフィア府中', address:'東京都府中市府中', access:'府中駅 徒歩8分', rent: 30000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
...
propertyZ=Property.create!(
    area_id: area_other.id,area_group_id: area_group_other.id,property_name:'hause西八王子', address:'東京都八王子市西八王子', access:'西八王子駅 徒歩3分', rent: 30000, condition:'男女どちらともOK', vacancy:6, common_service_fee:15000,
